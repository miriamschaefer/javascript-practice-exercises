...
let bornIn1500 = inventors.filter(
...
let sortByDate = inventors.sort((a, b) => (a.year > b.year ? 1 : -1));
...
let sortByLastName = inventors.sort(function (a, b) {
  let textA = a.last.toUpperCase();
  let textB = b.last.toUpperCase();
